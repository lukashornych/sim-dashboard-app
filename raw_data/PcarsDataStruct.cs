...
{
    public struct PcarsParticipantDataStruct
    {
        [MarshalAs(UnmanagedType.I1)]
        public bool mIsActive;

        [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = (int)pcars_enums.ePCarsDataStrucLength.STRING_LENGTH_MAX)]
        public string mName;                                    // [ string ]

        [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = (int)pcars_enums.eVector.VEC_MAX)]
    ...
    public struct PcarsDataStruct
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = (int)pcars_enums.ePCarsDataStrucLength.NUM_PARTICIPANTS)]
        public PcarsParticipantDataStruct[] mParticipantData;
        ...
        // Wheels / Tyres
        [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = (int)pcars_enums.eTyres.TYRE_MAX)]
